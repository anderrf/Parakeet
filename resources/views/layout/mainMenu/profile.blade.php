            ...
            <form action="" method="POST" class="w-full grid grid-cols-2">
                ...
                <div class="text-lg">
                    <div class="w-full flex flex-col my-1">
                        ...
                        <input type="text" name="profileName" id="profileName" class="border border-green-600 px-1">
                    </div>
                    <div class="w-full flex flex-col my-1">
                        <label for="profileEmail">E-mail</label>
                        <input type="email" name="profileEmail" id="profileEmail" class="border border-green-600 px-1">
                    </div>
                    <div class="w-full flex flex-col my-1">
                        <label for="profileNewPassword">Senha</label>
                        <input type="password" name="profileNewPassword" id="profileNewPassword" class="border border-green-600 px-1">
                    </div>
                    <div class="w-full flex flex-col my-1 showEdit">
                        <label for="profileOldPassword">Confirme as alterações com a senha antiga</label>
                        <input type="password" name="profileOldPassword" id="profileOldPassword" class="border border-green-600 px-1">
                    </div>
